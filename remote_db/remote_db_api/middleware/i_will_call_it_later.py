db_stuff = {'mssql': {'account_type_id': 1,
                      ...
                      'edit_user_query': lambda user_login, new_account_login,
                          ...
                          f"ALTER LOGIN {user_login} WITH NAME = {new_account_login};",
                          f"ALTER LOGIN {new_account_login} WITH PASSWORD = '{new_account_password}';"],
            ...
            'postgresql': {'account_type_id': 2,
                           ...
                           'edit_user_query': lambda user_login, new_account_login,
                                                     new_account_password: [
                               f"ALTER USER {user_login} RENAME TO {new_account_login};",
                               f"ALTER USER {new_account_login} WITH PASSWORD '{new_account_password}';"],
                           'create_database_query': lambda database_name, account_login: [
            ...
            'mysql': {'account_type_id': 3,
                      ...
                      'edit_user_query': lambda user_login, new_account_login,
                                                new_account_password: [
                          f"RENAME USER '{user_login}'@'localhost' TO '{new_account_login}'@'localhost';",
                          f"SET PASSWORD FOR '{new_account_login}'@'localhost' = PASSWORD('{new_account_password}');"],
